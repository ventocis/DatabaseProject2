...
DROP TABLE SpecialSpaces CASCADE CONSTRAINTS;
...
--	
CONSTRAINT SPIC1 CHECK ((property_type = 'Utility' OR property_type = 'RailRoad') AND price <= 250)
);
...
insert into SpecialSpaces values (1, 'Go');
insert into SpecialSpaces values (5, 'Income Tax');
insert into SpecialSpaces values (11, 'Jail');
insert into SpecialSpaces values (21, 'Free Parking');
insert into SpecialSpaces values (31, 'Go To Jail');
insert into SpecialSpaces values (39, 'Luxury Tax');
